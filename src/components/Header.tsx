    ...
    <nav className="sticky top-0 z-20 backdrop-blur-md bg-[#202020] border-b border-white/10">
      <div className="mx-auto flex w-[min(1200px,94vw)] items-center justify-between py-3">
        ...
        <div className="flex flex-col items-end gap-2 sm:flex-row sm:items-center">
          <a
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-pill border border-brand bg-transparent px-3 py-1.5 text-[13px] sm:px-4 sm:py-2 sm:text-[15px] font-semibold text-brand transition hover:-translate-y-[1px] hover:bg-white/5"
            href="/sales"
          >
