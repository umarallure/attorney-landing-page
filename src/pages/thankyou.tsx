            ...
            <div className="w-full max-w-[1500px]">
              <div className="mx-auto w-full overflow-hidden rounded-[26px] bg-[#d9d9d9] shadow-[0_18px_50px_rgba(0,0,0,0.35)]">
                <div className="flex aspect-[16/9] w-full items-center justify-center sm:aspect-[21/9]">
                  <span className="text-base font-semibold tracking-wide text-[#1a1a1a] sm:text-lg">Loom Video</span>
                </div>
              </div>
            ...
            <div className="w-full max-w-[980px] text-center">
              ...
              <div className="mt-12 w-full text-center">
                ...
                <div className="mt-3 flex items-center justify-center gap-6">
                  ...
                  <a href="#" className="text-brand transition-all hover:scale-110 hover:text-[#CC3F08]" aria-label="Facebook">
                    <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                  </a>
                  <a href="#" className="text-brand transition-all hover:scale-110 hover:text-[#CC3F08]" aria-label="Twitter">
                    <svg className="h-6 w-6 sm:h-7 sm:w-7" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                  </a>
                </div>
                <div className="mt-6 text-xs text-[#c8c8c8] sm:text-sm">© 2026 Accident Payments. All Rights Reserved</div>
              </div>
            </div>
          </section>
        </div>
